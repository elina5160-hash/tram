...
function Item({ href, renderIcon, label }: { href: string; renderIcon: (state: { pressed: boolean; isActive: boolean }) => React.ReactNode; label: string }) {
...
export default function BottomBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-20 w-full flex items-center justify-center px-3">
      <div className="relative w-full max-w-[420px] h-[52px] rounded-[20px] bg-[#232323]/50 border border-gray-400/60 shadow-inner mb-[12px] px-4 flex items-center justify-between overflow-hidden">
        ...
        />
        <Item
          href="https://t.me/avatime_cosmetics_income"
          label="Поддержка"
          renderIcon={() => (
            <svg className="w-[24px] h-auto" viewBox="0 0 34 27" fill="none" xmlns="http://www.w3.org/2000/svg">
