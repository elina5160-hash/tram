  ...
  return (
    <div className="fixed inset-0 z-[100] flex justify-end">
      ...
      <div className={menuView === "grid"
        ? "relative h-full w-[66vw] bg-white rounded-l-[20px] p-4 overflow-y-auto flex flex-col shadow-2xl"
        : "relative h-full w-[66vw] bg-white rounded-l-[20px] p-4 overflow-y-auto flex flex-col shadow-2xl"
      }>
        {menuView === "grid" ? (
          <>
          ...
          <div className="relative h-full flex flex-col">
            ...
            <div className="rounded-[20px] bg-[#F1F1F1] p-4 text-[#232323] text-[13px] leading-relaxed overflow-y-auto">
              {menuView === "delivery" && (
                <>
